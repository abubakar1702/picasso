...
STOCK_PALETTES = [
	...
	{
		"title": "Ink",
		"description": "Indigo navy chrome, even in light mode.",
		"accent_color": "#6366F1",
		"navbar_color_start": "#0B1220",
		"navbar_color_end": "#111827",
		"navbar_text_color": "#F8FAFC",
		"sidebar_color_start": "#111827",
		"sidebar_color_end": "#0B1220",
		"sidebar_text_color": "#E0E7FF",
		"sidebar_hover_background": "#1E1B4B",
		"sidebar_selected_background": "#3730A3",
		"page_background": "#F4F4F7",
		"page_head_background": "#F8F8FC",
		"page_head_text_color": "#111827",
		"page_head_separator_color": "#818CF8",
		"list_card_background": "#FFFFFF",
		"list_filter_background": "#F8F8FC",
		"list_header_background": "#EEF2FF",
		"list_row_hover_background": "#EEF2FF",
		"list_border_color": "#E0E7FF",
		"shadow_color": "#0B1220",
		"dark_accent_color": "#818CF8",
		"dark_navbar_color_start": "#070B14",
		"dark_navbar_color_end": "#070B14",
		"dark_navbar_text_color": "#E0E7FF",
		"dark_sidebar_color_start": "#0B1220",
		"dark_sidebar_color_end": "#0B1220",
		"dark_sidebar_text_color": "#E0E7FF",
		"dark_sidebar_hover_background": "#1E1B4B",
		"dark_sidebar_selected_background": "#3730A3",
		"dark_page_background": "#07070C",
		"dark_page_head_background": "#0F172A",
		"dark_page_head_text_color": "#E0E7FF",
		"dark_page_head_separator_color": "#818CF8",
		"dark_list_card_background": "#0F172A",
		"dark_list_filter_background": "#0F172A",
		"dark_list_header_background": "#1E1B4B",
		"dark_list_row_hover_background": "#1E1B4B",
		"dark_list_border_color": "#1E293B",
		"dark_shadow_color": "#000000",
	},
	{
		"title": "Sand",
